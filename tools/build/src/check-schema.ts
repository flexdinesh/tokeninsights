...
const EMBEDDED_SCHEMA_SQL_PATH = new URL("../../../packages/cli/internal/db/schema/schema.sql", import.meta.url).pathname;
const SCHEMA_GO_PATH = new URL("../../../packages/cli/internal/db/schema.go", import.meta.url).pathname;
